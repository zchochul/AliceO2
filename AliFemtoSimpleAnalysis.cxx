...
static constexpr std::string_view nsigm[6] = {"NSigmaTpcVsMomentumPr", "NSigmaTpcVsMomentumKa", "NSigmaTpcVsMomentumPi", "NSigmaTofVsMomentumPr", "NSigmaTofVsMomentumKa", "NSigmaTofVsMomentumPi"};
  HistogramRegistry registry {
	...
	{"ptPr", "pt proton", {HistType::kTH1F, {{100, -0.01, 10.01, "#it{p}_{T} (GeV/c)"}}}},
      	{"NSigmaTpcVsMomentumPr", "NSigmaTpcVsMomentumPr;#it{p}_{T} (GeV/c); NSigma TPC", {HistType::kTH2F, {{500, 0, 10}, {500, 0, 6000}}}},
	{"NSigmaTpcVsMomentumKa", "NSigmaTpcVsMomentumKa;#it{p}_{T} (GeV/c); NSigma TPC", {HistType::kTH2F, {{500, 0, 10}, {500, 0, 4000}}}},
	{"NSigmaTpcVsMomentumPi", "NSigmaTpcVsMomentumPi;#it{p}_{T} (GeV/c); NSigma TPC", {HistType::kTH2F, {{500, 0, 10}, {500, 0, 1000}}}},
	{"NSigmaTofVsMomentumPr", "NSigmaTofVsMomentumPr;#it{p}_{T} (GeV/c); NSigma TOF", {HistType::kTH2F, {{500, 0, 10}, {500, 0, 100000}}}},
	{"NSigmaTofVsMomentumKa", "NSigmaTofVsMomentumKa;#it{p}_{T} (GeV/c); NSigma TOF", {HistType::kTH2F, {{500, 0, 10}, {500, 0, 100000}}}},
	{"NSigmaTofVsMomentumPi", "NSigmaTofVsMomentumPi;#it{p}_{T} (GeV/c); NSigma TOF", {HistType::kTH2F, {{500, 0, 10}, {500, 0, 100000}}}}
	}
  };
