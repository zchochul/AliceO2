...
struct femtoDreamPairTaskTrackTrack {
  ...
  Configurable<uint32_t> ConfCutPartOne{"ConfCutPartOne", 2771237, "Particle 1 - Selection bit from cutCulator"};
  ...
  Configurable<uint32_t> ConfCutPartTwo{"ConfCutPartTwo", 2771237, "Particle 2 - Selection bit"};
