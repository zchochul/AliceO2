...
/// \file AliFemtoDetaDphiStar.h
/// \brief AliFemtoDetaDphiStar - Checks particles for the close pair rejection.
...
template <o2::aod::alifemtoparticle::ParticleType partOne, o2::aod::alifemtoparticle::ParticleType partTwo>
class AliFemtoDetaDphiStar
{
 public:
  /// Destructor
  virtual ~AliFemtoDetaDphiStar() = default;
  ...
  void init(HistogramRegistry* registry, HistogramRegistry* registryQA, float ldeltaPhiMax, float ldeltaEtaMax, bool lplotForEveryRadii)
  {
    ...
    if constexpr (mPartOneType == o2::aod::alifemtoparticle::ParticleType::kTrack && mPartTwoType == o2::aod::alifemtoparticle::ParticleType::kTrack) {
    ...
    if constexpr (mPartOneType == o2::aod::alifemtoparticle::ParticleType::kTrack && mPartTwoType == o2::aod::alifemtoparticle::ParticleType::kV0) {
      for (int i = 0; i < 2; i++) {
  ...
  bool isClosePair(Part const& part1, Part const& part2, Parts const& particles, float lmagfield)
  {
    ...
    if constexpr (mPartOneType == o2::aod::alifemtoparticle::ParticleType::kTrack && mPartTwoType == o2::aod::alifemtoparticle::ParticleType::kTrack) {
      ...
      if (part1.partType() != o2::aod::alifemtoparticle::ParticleType::kTrack || part2.partType() != o2::aod::alifemtoparticle::ParticleType::kTrack) {
        LOG(fatal) << "AliFemtoDetaDphiStar: passed arguments don't agree with AliFemtoDetaDphiStar instantiation! Please provide kTrack,kTrack candidates.";
        return false;
      }
    ...
    } else if constexpr (mPartOneType == o2::aod::alifemtoparticle::ParticleType::kTrack && mPartTwoType == o2::aod::alifemtoparticle::ParticleType::kV0) {
      /// Track-V0 combination
      // check if provided particles are in agreement with the class instantiation
      if (part1.partType() != o2::aod::alifemtoparticle::ParticleType::kTrack || part2.partType() != o2::aod::alifemtoparticle::ParticleType::kV0) {
        LOG(fatal) << "AliFemtoDetaDphiStar: passed arguments don't agree with AliFemtoDetaDphiStar instantiation! Please provide kTrack,kV0 candidates.";
        return false;
      }
 ...
 private:
  ...
  static constexpr o2::aod::alifemtoparticle::ParticleType mPartOneType = partOne; ///< Type of particle 1
  static constexpr o2::aod::alifemtoparticle::ParticleType mPartTwoType = partTwo; ///< Type of particle 2
  ...
  void PhiAtRadiiTPC(const T& part, std::vector<float>& tmpVec)
  {
    ...
    if ((part.cut() & kSignMinusMask) == kValue0 && (part.cut() & kSignPlusMask) == kValue0) {
      ...
      LOG(fatal) << "AliFemtoDetaDphiStar: Charge bits are set wrong!";
    }
...
#endif /* ANALYSIS_TASKS_PWGCF_ALIFEMTO_ALIFEMTODETADPHISTAR_H_ */
