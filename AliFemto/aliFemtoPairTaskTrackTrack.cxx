...
struct aliFemtoPairTaskTrackTrack { //new AliFemto name
  ...
  Partition<aod::AliFemtoParticles> partsOne = (aod::alifemtoparticle::partType == uint8_t(aod::alifemtoparticle::ParticleType::kTrack)) && ((aod::alifemtoparticle::cut & ConfCutPartOne) == ConfCutPartOne);

  /// Histogramming for particle 1 //new AliFemto name
  AliFemtoParticleHisto<aod::alifemtoparticle::ParticleType::kTrack, 1> trackHistoPartOne;
  ...
  Partition<aod::AliFemtoParticles> partsTwo = (aod::alifemtoparticle::partType == uint8_t(aod::alifemtoparticle::ParticleType::kTrack)) &&
                                                 //  (aod::alifemtoparticle::pt < cfgCutTable->get("PartTwo", "MaxPt")) &&
                                                 ((aod::alifemtoparticle::cut & ConfCutPartTwo) == ConfCutPartTwo);

  /// Histogramming for particle 2 //new AliFemto name
  AliFemtoParticleHisto<aod::alifemtoparticle::ParticleType::kTrack, 2> trackHistoPartTwo;
  ...
  AliFemtoPairCleaner<aod::alifemtoparticle::ParticleType::kTrack, aod::alifemtoparticle::ParticleType::kTrack> pairCleaner;
  AliFemtoDetaDphiStar<aod::alifemtoparticle::ParticleType::kTrack, aod::alifemtoparticle::ParticleType::kTrack> pairCloseRejection;
  /// Histogram output
  ...
  void processSameEvent(o2::aod::AliFemtoCollision& col,
                        o2::aod::AliFemtoParticles& parts)
  {
    const auto& tmstamp = col.timestamp();
    const auto& magFieldTesla = getMagneticFieldTesla(tmstamp, ccdb);
    //new AliFemto name
    auto groupPartsOne = partsOne->sliceByCached(aod::alifemtoparticle::aliFemtoCollisionId, col.globalIndex());
    //new AliFemto name
    auto groupPartsTwo = partsTwo->sliceByCached(aod::alifemtoparticle::aliFemtoCollisionId, col.globalIndex());
  ...
  void processMixedEvent(o2::aod::AliFemtoCollisions& cols,
                         o2::aod::AliFemtoParticles& parts)
  {

    BinningPolicy<aod::collision::PosZ, aod::alifemtocollision::MultV0M> colBinning{{CfgVtxBins, CfgMultBins}, true};

    for (auto& [collision1, collision2] : soa::selfCombinations(colBinning, 5, -1, cols, cols)) {
      //new AliFemto name
      auto groupPartsOne = partsOne->sliceByCached(aod::alifemtoparticle::aliFemtoCollisionId, collision1.globalIndex());
      //new AliFemto name
      auto groupPartsTwo = partsTwo->sliceByCached(aod::alifemtoparticle::aliFemtoCollisionId, collision2.globalIndex());
