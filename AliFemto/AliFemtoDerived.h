...
#ifndef ANALYSIS_TASKS_PWGCF_ALIFEMTO_ALIFEMTODERIVED_H_
#define ANALYSIS_TASKS_PWGCF_ALIFEMTO_ALIFEMTODERIVED_H_
...
DECLARE_SOA_TABLE(AliFemtoCollisions, "AOD", "FEMTODREAMCOLS",
                  o2::soa::Index<>,
                  o2::aod::collision::PosZ,
                  alifemtocollision::MultV0M,
                  alifemtocollision::Sphericity,
                  timestamp::Timestamp);
using AliFemtoCollision = AliFemtoCollisions::iterator;

/// AliFemtoTrack
namespace alifemtoparticle
{
...
DECLARE_SOA_INDEX_COLUMN(AliFemtoCollision, aliFemtoCollision);
DECLARE_SOA_COLUMN(Pt, pt, float);                    //! p_T (GeV/c)
DECLARE_SOA_COLUMN(Eta, eta, float);                  //! Eta
DECLARE_SOA_COLUMN(Phi, phi, float);                  //! Phi
DECLARE_SOA_COLUMN(PartType, partType, uint8_t);      //! Type of the particle, according to alifemtoparticle::ParticleType
...
DECLARE_SOA_TABLE(AliFemtoParticles, "AOD", "FEMTODREAMPARTS",
                  o2::soa::Index<>,
                  alifemtoparticle::AliFemtoCollisionId,
                  alifemtoparticle::Pt,
                  alifemtoparticle::Eta,
                  alifemtoparticle::Phi,
                  alifemtoparticle::PartType,
                  alifemtoparticle::Cut,
                  alifemtoparticle::PIDCut,
                  alifemtoparticle::TempFitVar,
                  alifemtoparticle::Indices,
                  alifemtoparticle::MLambda,
                  alifemtoparticle::MAntiLambda,
                  alifemtoparticle::Theta<alifemtoparticle::Eta>,
                  alifemtoparticle::Px<alifemtoparticle::Pt, alifemtoparticle::Phi>,
                  alifemtoparticle::Py<alifemtoparticle::Pt, alifemtoparticle::Phi>,
                  alifemtoparticle::Pz<alifemtoparticle::Pt, alifemtoparticle::Eta>,
                  alifemtoparticle::P<alifemtoparticle::Pt, alifemtoparticle::Eta>);
using AliFemtoParticle = AliFemtoParticles::iterator;

DECLARE_SOA_TABLE(AliFemtoDebugParticles, "AOD", "FEMTODEBUGPARTS",
                  alifemtoparticle::Sign,
                  alifemtoparticle::TPCNClsFound,
                  track::TPCNClsFindable,
                  alifemtoparticle::TPCNClsCrossedRows,
                  track::TPCNClsShared,
                  track::TPCInnerParam,
                  alifemtoparticle::ITSNCls,
                  alifemtoparticle::ITSNClsInnerBarrel,
                  track::DcaXY,
                  track::DcaZ,
                  track::TPCSignal,
                  ...
                  alifemtoparticle::DaughDCA,
                  alifemtoparticle::TransRadius,
                  alifemtoparticle::DecayVtxX,
                  alifemtoparticle::DecayVtxY,
                  alifemtoparticle::DecayVtxZ,
                  alifemtoparticle::TPCCrossedRowsOverFindableCls<track::TPCNClsFindable, alifemtoparticle::TPCNClsCrossedRows>,
...
using AliFemtoDebugParticle = AliFemtoDebugParticles::iterator;
...
#endif /* ANALYSIS_TASKS_PWGCF_ALIFEMTO_ALIFEMTODERIVED_H_ */
